...
function optionsframework_options() {
	...
	$section_title       = array("","About Us","Services","Gallery","Timeline","Team","Contact");
	$section_menu        = array("Home","About Us","Services","Gallery","Timeline","Team","Contact");
	$default_section_num = count($section_menu);
	$section_num         = onetone_options_array('section_num');
	$section_num         = (!is_numeric( $section_num ))?$default_section_num:$section_num;
...
[team style='1' name='Andrea Arkov' byline='Public Relations' avatar='".ONETONE_THEME_BASE_URL."/images/team-img-1.jpg' social_icon_1='skype' social_link_1='#' social_icon_2='facebook' social_link_2='#' social_icon_3='twitter' social_link_3='#' social_icon_4='youtube' social_link_4='#' ]Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.[/team]
[/column]
[column col_sm='6' col_md='3' ]
[team style='1' name='Andrea Arkov' byline='Public Relations' avatar='".ONETONE_THEME_BASE_URL."/images/team-img-2.jpg' social_icon_1='skype' social_link_1='#' social_icon_2='facebook' social_link_2='#' social_icon_3='twitter' social_link_3='#' social_icon_4='youtube' social_link_4='#' ]Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.[/team]
[/column]
[column col_sm='6' col_md='3' ]
[team style='1' name='Andrea Arkov' byline='Public Relations' avatar='".ONETONE_THEME_BASE_URL."/images/team-img-3.jpg' social_icon_1='skype' social_link_1='#' social_icon_2='facebook' social_link_2='#' social_icon_3='twitter' social_link_3='#' social_icon_4='youtube' social_link_4='#' ]Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.[/team]
[/column]
[column col_sm='6' col_md='3' ]
[team style='1' name='Andrea Arkov' byline='Public Relations' avatar='".ONETONE_THEME_BASE_URL."/images/team-img-4.jpg' ]Come to join us.[/team]
[/column]
[/row]"
,
...
/*	$options[] = array(
	...
	////Header
	   ...
	   $options[] = array(
		...
		$options[] = array(	'name' => __('Header Cover Video Background', 'onetone'),'desc' => '','id' => 'header_cover_video_background_html5','std' => '1','class' => 'mini','options' => array('1'=>'yes','0'=>'no'),'type' => 'select');
		...
		$options[] = array(	'name' => __('Video Fixed', 'onetone'),'desc' => '','id' => 'video_full_screen','std' => '1','class' => 'mini','options' => array('1'=>'yes','0'=>'no'),'type' => 'select');
		
		$options[] = array(	'name' => __('Header Cover Video Background', 'onetone'),'desc' => '','id' => 'header_cover_video_background','std' => '1','class' => 'mini','options' => array('1'=>'yes','0'=>'no'),'type' => 'select');
		...
		$options[] = array('name' => __('Video Background Section (YouTube Video)', 'onetone'),'std' => '1','id' => 'video_background_section',
		...
		'type' => 'select','class' => 'mini','options'=>array("content"=>"Content","slider"=>"Slider"));
		...
		$options[] = array('name' => sprintf(__('Section %s', 'onetone'),($i+1)),'id' => 'section_group_start_'.$i.'','type' => 'start_group','class'=>'home-section group_close');
	   ...
	   $options[] = array(
		...
		'std'  => $section_content_typography_defaults,
		'type' => 'typography',
		'options' => $typography_options );
	   ...
	   $options[] = array(
		...
		//END HOME PAGE SECTION
			...
			// Slider
		$options[] = array(	'name' => __('Homepage Slider', 'onetone'),'type' => 'heading');
	...
	/*	$options[] = array(
		...
		// Shop
		$options[] = array(	'name' => __('Shop', 'onetone'),'type' => 'heading');
		
		$options[] = array('name' => __('Product Archive Sidebar', 'onetone'),'std' => 'content','id' => 'product_archive_sidebar',
		'type' => 'select','class' => 'mini','options'=>array('none'=>__('none', 'onetone'),'left'=>__('left', 'onetone'),'right'=>__('right', 'onetone')));
		
		$options[] = array('name' => __('Single Product Sidebar', 'onetone'),'std' => 'content','id' => 'single_product_sidebar',
		'type' => 'select','class' => 'mini','options'=>array('none'=>__('none', 'onetone'),'left'=>__('left', 'onetone'),'right'=>__('right', 'onetone')));
		
		$options[] = array('name' => __('Shop Template Page Sidebar', 'onetone'),'std' => 'content','id' => 'shop_template_page_sidebar',
		'type' => 'select','class' => 'mini','options'=>array('none'=>__('none', 'onetone'),'left'=>__('left', 'onetone'),'right'=>__('right', 'onetone')));
