...
<?php
 ...
 $section_content_typography  = onetone_options_array( 'section_content_typography_'.$i);
 $_section_title_typography   = onetone_get_typography( $section_content_typography );
 ...
 if( !$sanitize_title && $section_menu  && $section_menu  != ""){
 ...
 if( $video_enable == 1 && $video_background_type == "youtube"){
    ...
    $background_video  = array("videoId"=>$section_background_video, "start"=>3 ,"mute"=>false,"container" =>"section.onetone-".$sanitize_title,"playerid"=>$sanitize_title,'video_full_screen' => $video_full_screen);
 ...
 if( $parallax_scrolling == "yes" ){
	 ...
	 $background .= 'background-attachment:fixed;background-position:50% 0;background-repeat:repeat;';
	 }
  ...
  $container_style .= $_section_title_typography ;
 ?>
 ...
 <?php
	 ...
	 if( $video_enable == 1 && $video_background_type == "html5" ){
		 ...
		 $header_cover_video_background_html5 = onetone_options_array( "header_cover_video_background_html5" ,1);
		 if( $video_loop == 1 ){
		$video_loop = "true";
		}
		else{
		$video_loop = "false";	
		 ...
		 echo '<script type="text/javascript" src="'.get_template_directory_uri().'/js/jquery-ui.min.js"></script>';
		 ...
		 echo '<script type="text/javascript" > 
            ...
            var BV = new jQuery.BigVideo({
				...
				if( $header_cover_video_background_html5 == '0'){
					echo 'container:jQuery("#'.$sanitize_title.'")';
				}
			echo '});
			BV.init();
			if (Modernizr.touch) {
